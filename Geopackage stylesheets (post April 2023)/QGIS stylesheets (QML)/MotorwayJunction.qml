...
<qgis version="3.16.7-Hannover" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="100000" readOnly="0" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" textOrientation="horizontal" fontFamily="Arial" textColor="255,255,255,255" fontSizeUnit="Point" fontWeight="75" fontWordSpacing="0" fontStrikeout="0" textOpacity="1" multilineHeight="1" isExpression="1" fontSize="12" fontItalic="0" fontLetterSpacing="0" fieldName="CASE WHEN &quot;junction_number&quot; LIKE '%/%' THEN &#xd;&#xa;concat(&#xd;&#xa;(&#xd;&#xa;substr(&quot;junction_number&quot;, strpos(&quot;junction_number&quot;,'J')+1, strpos(&quot;junction_number&quot;,'/') - strpos(&quot;junction_number&quot;,'J')-1)&#xd;&#xa;)&#xd;&#xa;+&#xd;&#xa;' ⁞ ' &#xd;&#xa;+&#xd;&#xa;(regexp_replace(&quot;junction_number&quot;, 'M.*J', ''))&#xd;&#xa;)&#xd;&#xa;&#xd;&#xa;ELSE &#xd;&#xa;&#xd;&#xa;(regexp_replace(&quot;junction_number&quot;, 'M.*J', ''))&#xd;&#xa;&#xd;&#xa;END" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" blendMode="0" fontKerning="1" previewBkgrdColor="255,255,255,255" namedStyle="Bold" allowHtml="0" capitalization="0">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="junction_number">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="2" field="junction_number" name=""/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="fid" expression=""/>
    <default applyOnUpdate="0" field="id" expression=""/>
    <default applyOnUpdate="0" field="junction_number" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint notnull_strength="0" field="junction_number" constraints="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="fid" exp="" desc=""/>
    <constraint field="id" exp="" desc=""/>
    <constraint field="junction_number" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="junction_number"/>
    </columns>
