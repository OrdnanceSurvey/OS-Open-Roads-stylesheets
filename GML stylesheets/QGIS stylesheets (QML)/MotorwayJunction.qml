...
<qgis version="3.16.7-Hannover" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="100000" readOnly="0" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" textOrientation="horizontal" fontFamily="Arial" textColor="255,255,255,255" fontSizeUnit="Point" fontWeight="75" fontWordSpacing="0" fontStrikeout="0" textOpacity="1" multilineHeight="1" isExpression="1" fontSize="12" fontItalic="0" fontLetterSpacing="0" fieldName="CASE WHEN &quot;junctionNumber&quot; LIKE '%/%' THEN &#xd;&#xa;concat(&#xd;&#xa;(&#xd;&#xa;substr(&quot;junctionNumber&quot;, strpos(&quot;junctionNumber&quot;,'J')+1, strpos(&quot;junctionNumber&quot;,'/') - strpos(&quot;junctionNumber&quot;,'J')-1)&#xd;&#xa;)&#xd;&#xa;+&#xd;&#xa;' ⁞ ' &#xd;&#xa;+&#xd;&#xa;(regexp_replace(&quot;junctionNumber&quot;, 'M.*J', ''))&#xd;&#xa;)&#xd;&#xa;&#xd;&#xa;ELSE &#xd;&#xa;&#xd;&#xa;(regexp_replace(&quot;junctionNumber&quot;, 'M.*J', ''))&#xd;&#xa;&#xd;&#xa;END" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" blendMode="0" fontKerning="1" previewBkgrdColor="255,255,255,255" namedStyle="Bold" allowHtml="0" capitalization="0">
  ...
  <aliases>
    ...
    <alias index="1" field="junctionNumber" name=""/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="gml_id" expression=""/>
    <default applyOnUpdate="0" field="junctionNumber" expression=""/>
  </defaults>
  <constraints>
    <constraint notnull_strength="1" field="gml_id" constraints="1" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="junctionNumber" constraints="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="gml_id" exp="" desc=""/>
    <constraint field="junctionNumber" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
