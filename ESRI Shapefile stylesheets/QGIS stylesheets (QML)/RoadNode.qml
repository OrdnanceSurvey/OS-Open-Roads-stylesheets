...
<qgis version="3.16.7-Hannover" labelsEnabled="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" minScale="25000" hasScaleBasedVisibilityFlag="1" maxScale="0" readOnly="0" simplifyDrawingTol="1">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="formOfNode">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="1" field="formOfNode" name=""/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="identifier" expression=""/>
    <default applyOnUpdate="0" field="formOfNode" expression=""/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" field="identifier" constraints="0" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="formOfNode" constraints="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="identifier" exp="" desc=""/>
    <constraint field="formOfNode" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="formOfNode"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="formOfNode"/>
    <field editable="1" name="identifier"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="formOfNode"/>
